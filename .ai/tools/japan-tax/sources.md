...
核对日期：2026-09-06。适用 2025 年工资收入、2026 年度住民税。本索引取代原有空壳阶段的待定口径；当前范围见 spec.md，算法与舍入见 rules.md、settlement-rules.md 和 credits-rules.md。
...
详见 [deduction-coverage-review.md](./spec.md)。DC/iDeCo已有本人缴费入口，社保中的支援金不另列重复扣除；后续已接入房贷税額控除及子女/特别残障类所得金額調整控除，详见credits-rules.md。已补充各项条件、票据内书拆分及官方依据。新增资料后43个官方URL可访问，source-link-audit.json为最新结果。
