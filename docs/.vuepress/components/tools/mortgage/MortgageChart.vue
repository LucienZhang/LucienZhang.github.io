...
<template>
  <svg ref="svg" :viewBox="`0 0 ${width} ${height}`" :style="{height:height+'px'}" role="img" :aria-labelledby="`${id}-title ${id}-desc`" @pointerdown="select" @pointerleave="hovered=null" @keydown.esc="hovered=null">
